...
is described below. The enum class `position``, like the `iterator\_preorder` class, implements a finite state machine that consists of three possible positions...
