...
Alternately, to always ensure a parent can always accomodate a new key, we can split all 4-nodes as we descend the tree. 

.. todo:: Add any other relevant illustrations
