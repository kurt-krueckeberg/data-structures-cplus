...
The worse case for when a key is found, occurs when the search range has been narrowed to element and lo = hi = mid-point. The exact same number of steps are required
